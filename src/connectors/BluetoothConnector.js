 ...
 *
 * Exposes an api for controlling the drone using BLE
 *
 ...
 */
module.exports = class BluetoothConnector extends AbstractDroneConnector {
  /**
   * Creates a new DroneConnection instance
   * @param {object} options - Instance options
   * @param {string} [options.droneFilter=] - The drone name leave blank for no filter
